...
#define kCalendar [NSCalendar autoupdatingCurrentCalendar]
...
- (NSInteger)timeIntervalGMT
{
//    NSTimeInterval gtm = [[NSTimeZone defaultTimeZone] secondsFromGMT];
...
+ (NSDate *)defaultAge
{
    ...
    NSDate *age = [[NSCalendar currentCalendar] dateFromComponents:components];
    return age;
}
@end
